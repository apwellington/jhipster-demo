...
import { DemoBootstrapCoreModule } from 'app/core';
import { DemoBootstrapAppRoutingModule } from './app-routing.module';
...
@NgModule({
    imports: [
        BrowserModule,
        DemoBootstrapAppRoutingModule,
        Ng2Webstorage.forRoot({ prefix: 'jhi', separator: '-' }),
        DemoBootstrapSharedModule,
...
export class DemoBootstrapAppModule {}
